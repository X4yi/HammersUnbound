...
public class SpikeHammerItem extends ItemHammer {
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        boolean isSprint = isSprintHit(player);

        if (isCrit && ServerConfig.spikehammerEnableBleeding) {
            onCriticalHit(target, attacker, stack);
        } else if (isSprint && ServerConfig.spikehammerEnableBleeding) {
    ...
    private void applyBleeding(EntityLivingBase target) {
