...
public class GuiConfigScreen extends GuiBaseScreen {
    ...
    private float getFloatValue(ConfigSection.SubSection sub, ConfigSection.ConfigField field) {
        ...
        if (sub.getId().startsWith("warhammer_")) {
            ...
            switch (key) {
                case "aoeRadiusMult": return ServerConfig.warhammerAoeRadiusMultiplier;
                case "aoeDamageMult": return ServerConfig.warhammerAoeDamageMultiplier;
            ...
            switch (key) {
                case "aoeCount": return ClientConfig.aoeParticleCount;
                case "aoeDensity": return ClientConfig.aoeParticleDensity;
                case "aoeMaxHeight": return ClientConfig.aoeMaxHeight;
            }
        }
    ...
    private void setFloatValue(ConfigSection.SubSection sub, ConfigSection.ConfigField field, float value) {
        ...
        if (sub.getId().startsWith("warhammer_")) {
            ...
            switch (key) {
                case "aoeRadiusMult": ServerConfig.warhammerAoeRadiusMultiplier = value; break;
                case "aoeDamageMult": ServerConfig.warhammerAoeDamageMultiplier = value; break;
            ...
            switch (key) {
                case "aoeCount": ClientConfig.aoeParticleCount = (int) value; break;
                case "aoeDensity": ClientConfig.aoeParticleDensity = value; break;
                case "aoeMaxHeight": ClientConfig.aoeMaxHeight = value; break;
            }
        }
    }
