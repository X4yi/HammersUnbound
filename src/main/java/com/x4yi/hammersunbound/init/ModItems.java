...
public class ModItems {
    ...
    // Keep the maps fully populated and available for other subsystems
    ...
    // Manually declared items for explicit control
    ...
    public static void onItemRegister(RegistryEvent.Register<Item> event) {
        ...
        // 1. Register War Hammers in strict manual order
        ...
        // 2. Register Spike Hammers in strict manual order
