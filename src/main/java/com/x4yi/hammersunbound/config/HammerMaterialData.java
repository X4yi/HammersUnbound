...
public class HammerMaterialData {
    ...
    public static HammerMaterialData fromJson(String name, JsonObject json) {
        ...
        int defaultCooldown = 100;
        if (name.equalsIgnoreCase("stone")) defaultCooldown = 120;
        else if (name.equalsIgnoreCase("iron")) defaultCooldown = 140;
        else if (name.equalsIgnoreCase("gold")) defaultCooldown = 80;
        else if (name.equalsIgnoreCase("diamond")) defaultCooldown = 160;
